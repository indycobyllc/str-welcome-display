...
function sanitize(input) {
  ...
  const durationPages = [...schedulePages, "holiday", "funFact", "celebration", "review"];
  ...
  return {
    ...
    showMorningShow: bool(input.showMorningShow),
    morningShowTime: /^([01]\d|2[0-3]):[0-5]\d$/.test(input.morningShowTime || "") ? input.morningShowTime : "08:00",
    morningShowDuration: Math.min(120, Math.max(45, Number(input.morningShowDuration) || 75)),
    showNightShow: bool(input.showNightShow),
    nightShowTime: /^([01]\d|2[0-3]):[0-5]\d$/.test(input.nightShowTime || "") ? input.nightShowTime : "20:55",
    nightShowDuration: Math.min(120, Math.max(50, Number(input.nightShowDuration) || 50)),
    showFullNightSpectacular: bool(input.showFullNightSpectacular),
    ...
    showCelebrationMessage: bool(input.showCelebrationMessage),
