...
const FUN_FACTS = [
  ...
  ["Detail Hunt · Liberty Tree", "Count the lanterns hanging from Liberty Square’s Liberty Tree. There are 13—one for each of the original American colonies."],
  ...
  ["Detail Hunt · Take the stairs", "At Tower of Terror, inspect the directory board in the abandoned lobby. Fallen letters at its base rearrange into a warning: TAKE THE STAIRS."],
  ...
  ["Detail Hunt · A strange song", "In Tower of Terror’s library, look beneath the trumpet for 1932 sheet music titled “What! No Mickey Mouse? What Kind of Party Is This?”"],
  ["Detail Hunt · Caesar", "Before leaving Tower of Terror, look for Caesar, the ventriloquist dummy from a classic Twilight Zone episode, waiting in the basement."],
  ...
  ["Detail Hunt · Kangaroos", "From the main Tree of Life photo area, turn left and watch the habitat on your right for western grey and red kangaroos."],
  ["Detail Hunt · Bruce", "Along the Discovery Island Trails near the Tree of Life Garden, look for Bruce, a paroon shark catfish—a species capable of growing to ten feet long."],
  ["Detail Hunt · The shy muntjac", "Take the right-hand Oasis trail and scan the brush on your left for Carly, a small Reeve’s muntjac that many guests walk straight past."],
  ...
  ["Detail Hunt · Pixar’s first Oscar", "At the Toy Story Mania! exit, find the open Little Golden Book for Tin Toy—the 1988 short that earned Pixar its first Academy Award."],
  ...
  ["Detail Hunt · Rat tracks", "In EPCOT’s expanded France pavilion, look down in Remy’s queue for tiny rat prints, then scan the railings, lamps and benches for more rat motifs."],
  ["Detail Hunt · Parked after dinner", "Outside Remy’s Ratatouille Adventure, Chef Skinner’s scooter and Colette’s motorbike are parked in the pavilion as full-size film Easter eggs."],
  ...
  ["Detail Hunt · Ratatouille storefronts", "Along EPCOT’s Allée des Marchands, find Anton Ego’s fictional wine shop and the health inspector’s office from Ratatouille."],
