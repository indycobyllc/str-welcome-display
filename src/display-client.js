// webOS 6 signage uses Chromium 79. Keep small runtime shims here so the same
// source can be compiled for the television without changing modern browsers.
...
const FUN_FACTS = [
  ...
  ["The Florida project", "Walt and Roy Disney began searching for an East Coast location in the early 1960s, looking for climate, access, land, and room to grow."],
  ["Roy carried the dream forward", "Roy O. Disney postponed retirement to help complete his brother’s Florida project and presided over its 1971 opening."],
  ["Built without lingering debt", "Walt Disney World cost about $400 million to construct and opened in 1971 with the company carrying no outstanding construction debt."],
  ["Guest number one", "William Windsor Jr. was recorded as Walt Disney World’s first guest on October 1, 1971."],
  ["The original resort pair", "Disney’s Contemporary Resort and Disney’s Polynesian Village Resort both welcomed guests on Walt Disney World’s opening day."],
  ["A monorail from day one", "Walt Disney World’s larger-scale Monorail system began operating with the resort on October 1, 1971."],
  ["The EPCOT beam", "The dedicated Monorail line between the Transportation and Ticket Center and EPCOT opened in June 1982."],
  ["Art above the concourse", "Mary Blair designed the enormous 90-foot mosaic murals inside Disney’s Contemporary Resort."],
  ["A train through a hotel", "The Walt Disney World Monorail glides directly through the open center of the Contemporary Resort above its fourth-floor concourse."],
  ["South Seas original", "Disney’s Polynesian Village Resort was one of Walt Disney World’s two original hotels and organizes its rooms into island-named longhouses."],
  ...
  ["An opening-day haunt", "Magic Kingdom’s Haunted Mansion has welcomed foolish mortals since the park opened on October 1, 1971."],
  ...
  ["Test Track by the numbers", "EPCOT’s Test Track course stretches 5,246 feet, and its vehicles reach 65 miles per hour."],
  ...
  ["Hollywood arrived in 1989", "The park now called Disney’s Hollywood Studios opened as Disney-MGM Studios on May 1, 1989."],
  ...
  ["Earth Day opening", "Disney’s Animal Kingdom opened on Earth Day—April 22, 1998."],
  ["Disney’s largest park", "At roughly 500 acres, Disney’s Animal Kingdom is the largest Walt Disney World theme park by area."],
  ["A safari bigger than Disneyland", "The savanna used by Kilimanjaro Safaris is larger than the entire original Disneyland Park."],
  ["More than 100 safari acres", "Kilimanjaro Safaris travels through more than 100 acres of savanna, forest, rivers, and rocky hills."],
  ["A tree full of animals", "More than 300 animal forms were sculpted into the trunk and roots of the Tree of Life."],
  ["Fourteen stories of nature", "The Tree of Life rises about 14 stories, measures roughly 50 feet wide, and spreads to 170 feet across at its base."],
  ["Hidden animal hunt", "At Animal Kingdom’s Oasis, take the right-hand trail and look into the greenery on the left for one of the park’s easy-to-miss animal habitats."],
  ["Look beyond the safari", "Animal Kingdom’s Gorilla Falls trail includes tiny naked mole rats whose fine sensory hairs help them navigate underground tunnels."],
  ["A train to conservation", "The Wildlife Express carries guests from Harambe to Rafiki’s Planet Watch and the park’s working veterinary facilities."],
  ["Hidden Mickey Hunt · Wilderness Lodge", "In the Wilderness Lodge lobby, study the stones of the towering fireplace—an official Disney clue points to a stone Mickey hidden there."],
  ["Hidden Mickey Hunt · Under the Sea", "Near the exit of Under the Sea – Journey of the Little Mermaid, study the rockwork for a remarkably subtle Steamboat Willie profile."],
  ["Hidden Mickey Hunt · Tatooine Traders", "At the build-your-own-lightsaber area, look low on a panel for three battle-scar circles arranged as Mickey’s head and ears."],
